...
import static first.robot.Constants.LoggingConstants.kSupersystemTab;
import static first.robot.Constants.Subsystems.conveyor;
import static first.robot.Constants.Subsystems.indexer;
import static first.robot.Constants.Subsystems.intakeRoller;
import static first.robot.Constants.Subsystems.intakeSlapdown;
import static first.robot.Constants.Subsystems.leds;
import static first.robot.Constants.Subsystems.shooter;
import static first.robot.Constants.Subsystems.useLEDs;
import static first.robot.Constants.Subsystems.hood;
